...
function Form(){
    ...
    function handleSubmit(e){
        ...
        Object.assign(createBlogFields, {id:shortid.generate(), like:0})

        if(validateForm()){

            dispatch(createPost(createBlogFields))

            toast.success("Successfully Blog !", {
    ...
    return(
                <form action="/" method="post" >
                    ...
                    <input type="text" name="title" id="title" value={createBlogFields.title} onChange={handleInputChange} />
